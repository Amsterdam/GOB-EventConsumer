...
node('GOBBUILD') {
    withEnv(["DOCKER_IMAGE_NAME=datapunt/gob_eventconsumer:${env.BUILD_NUMBER}"]) {
                ...
                tryStep "deployment", {
                    build job: 'Subtask_Openstack_Playbook',
                        parameters: [
                            ...
                            [$class: 'StringParameterValue', name: 'PLAYBOOKPARAMS', value: "-e cmdb_id=app_gob-eventconsumer"],
                        ]
                }
            }
        }
